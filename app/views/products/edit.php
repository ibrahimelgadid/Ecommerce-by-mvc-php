                        ...
                        <div class="card-body">
                            <form enctype='multipart/form-data' action="<?php echo URL?>/products/update/<?php echo $data['product']->product_id ?>" method="POST">
                                ...
                                <div class="form-group">
                                    <input value='<?php echo $data['product']->name?>' type="text" name="name" placeholder="Enter product name" class="form-control <?php echo  isset($data['errName']) ?  'is-invalid' : '' ?>">
                                    <?php echo  isset($data['errName']) ?  '<div class="invalid-feedback">'.$data['errName'].'</div>' : '' ?>
                                </div>
                                <div class="form-group">
                                    <input value='<?php echo $data['product']->color?>' type="text" name="color" placeholder="Enter color name" class="form-control <?php echo  isset($data['errColor']) ?  'is-invalid' : '' ?>">
                                    <?php echo  isset($data['errColor']) ?  '<div class="invalid-feedback">'.$data['errColor'].'</div>' : '' ?>
                                </div>
                                <div class="form-group">
                                    <input value='<?php echo $data['product']->size?>' type="text" name="size" placeholder="Enter size name" class="form-control <?php echo  isset($data['errSize']) ?  'is-invalid' : '' ?>">
                                    <?php echo  isset($data['errSize']) ?  '<div class="invalid-feedback">'.$data['errSize'].'</div>' : '' ?>
                                </div>
                                <div class="form-group">
                                    <input value='<?php echo $data['product']->price?>' type="text" name="price" placeholder="Enter product price" class="form-control <?php echo  isset($data['errPrice']) ?  'is-invalid' : '' ?>">
                                ...
                                <input type="hidden" name="csrf" value="<?php new Csrf(); echo Csrf::get()?>">
                                    ...
                                    <input type="submit" name='editProduct' value='Edit' class="btn btn-success btn-sm">
                                </div>
