        ...
        <table class="table table-dark table-responsive-md search">
            <thead>
                <tr>
                    <th>Series</th>
                    <th>Name</th>
        ...
        <?php  }else{?>
        <p class="text-center text-white pt-3 empty"><span class='btn btn-sm btn-danger' style='border-radius:50%'><i class="fa fa-warning"></i></span> There is no result</p>
        <?php  }?>
